...
export const NEETCODE_150: NeetCodeProblem[] = [
  ...
  { id: 'maximum-depth-of-binary-tree', name: 'Maximum Depth of Binary Tree', number: 104, difficulty: 'Easy', topicId: 'trees', link: 'https://leetcode.com/problems/maximum-depth-of-binary-tree/', hasVisualization: false },
  { id: 'diameter-of-binary-tree', name: 'Diameter of Binary Tree', number: 543, difficulty: 'Easy', topicId: 'trees', link: 'https://leetcode.com/problems/diameter-of-binary-tree/', hasVisualization: false },
  { id: 'balanced-binary-tree', name: 'Balanced Binary Tree', number: 110, difficulty: 'Easy', topicId: 'trees', link: 'https://leetcode.com/problems/balanced-binary-tree/', hasVisualization: false },
  { id: 'same-tree', name: 'Same Tree', number: 100, difficulty: 'Easy', topicId: 'trees', link: 'https://leetcode.com/problems/same-tree/', hasVisualization: false },
  { id: 'subtree-of-another-tree', name: 'Subtree of Another Tree', number: 572, difficulty: 'Easy', topicId: 'trees', link: 'https://leetcode.com/problems/subtree-of-another-tree/', hasVisualization: false },
  { id: 'lowest-common-ancestor-of-bst', name: 'Lowest Common Ancestor of BST', number: 235, difficulty: 'Medium', topicId: 'trees', link: 'https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/', hasVisualization: false },
  { id: 'binary-tree-level-order-traversal', name: 'Binary Tree Level Order Traversal', number: 102, difficulty: 'Medium', topicId: 'trees', link: 'https://leetcode.com/problems/binary-tree-level-order-traversal/', hasVisualization: false },
  { id: 'binary-tree-right-side-view', name: 'Binary Tree Right Side View', number: 199, difficulty: 'Medium', topicId: 'trees', link: 'https://leetcode.com/problems/binary-tree-right-side-view/', hasVisualization: false },
  { id: 'count-good-nodes', name: 'Count Good Nodes in Binary Tree', number: 1448, difficulty: 'Medium', topicId: 'trees', link: 'https://leetcode.com/problems/count-good-nodes-in-binary-tree/', hasVisualization: false },
  { id: 'validate-bst', name: 'Validate Binary Search Tree', number: 98, difficulty: 'Medium', topicId: 'trees', link: 'https://leetcode.com/problems/validate-binary-search-tree/', hasVisualization: false },
  { id: 'kth-smallest-element-in-bst', name: 'Kth Smallest Element in a BST', number: 230, difficulty: 'Medium', topicId: 'trees', link: 'https://leetcode.com/problems/kth-smallest-element-in-a-bst/', hasVisualization: false },
  { id: 'construct-binary-tree', name: 'Construct Binary Tree from Preorder and Inorder', number: 105, difficulty: 'Medium', topicId: 'trees', link: 'https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/', hasVisualization: false },
  { id: 'binary-tree-maximum-path-sum', name: 'Binary Tree Maximum Path Sum', number: 124, difficulty: 'Hard', topicId: 'trees', link: 'https://leetcode.com/problems/binary-tree-maximum-path-sum/', hasVisualization: false },
  { id: 'serialize-and-deserialize-binary-tree', name: 'Serialize and Deserialize Binary Tree', number: 297, difficulty: 'Hard', topicId: 'trees', link: 'https://leetcode.com/problems/serialize-and-deserialize-binary-tree/', hasVisualization: false },
  ...
  { id: 'max-area-of-island', name: 'Max Area of Island', number: 695, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/max-area-of-island/', hasVisualization: false },
  { id: 'clone-graph', name: 'Clone Graph', number: 133, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/clone-graph/', hasVisualization: false },
  { id: 'walls-and-gates', name: 'Walls and Gates', number: 286, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/walls-and-gates/', hasVisualization: false },
  { id: 'rotting-oranges', name: 'Rotting Oranges', number: 994, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/rotting-oranges/', hasVisualization: false },
  { id: 'pacific-atlantic-water-flow', name: 'Pacific Atlantic Water Flow', number: 417, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/pacific-atlantic-water-flow/', hasVisualization: false },
  { id: 'surrounded-regions', name: 'Surrounded Regions', number: 130, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/surrounded-regions/', hasVisualization: false },
  { id: 'course-schedule', name: 'Course Schedule', number: 207, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/course-schedule/', hasVisualization: false },
  { id: 'course-schedule-ii', name: 'Course Schedule II', number: 210, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/course-schedule-ii/', hasVisualization: false },
  { id: 'graph-valid-tree', name: 'Graph Valid Tree', number: 261, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/graph-valid-tree/', hasVisualization: false },
  { id: 'number-of-connected-components', name: 'Number of Connected Components', number: 323, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/', hasVisualization: false },
  { id: 'redundant-connection', name: 'Redundant Connection', number: 684, difficulty: 'Medium', topicId: 'graphs', link: 'https://leetcode.com/problems/redundant-connection/', hasVisualization: false },
  { id: 'word-ladder', name: 'Word Ladder', number: 127, difficulty: 'Hard', topicId: 'graphs', link: 'https://leetcode.com/problems/word-ladder/', hasVisualization: false },
  ...
  // 1-D DP (12)
  { id: 'climbing-stairs', name: 'Climbing Stairs', number: 70, difficulty: 'Easy', topicId: '1d-dp', link: 'https://leetcode.com/problems/climbing-stairs/', hasVisualization: false },
  { id: 'min-cost-climbing-stairs', name: 'Min Cost Climbing Stairs', number: 746, difficulty: 'Easy', topicId: '1d-dp', link: 'https://leetcode.com/problems/min-cost-climbing-stairs/', hasVisualization: false },
  { id: 'house-robber', name: 'House Robber', number: 198, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/house-robber/', hasVisualization: false },
  { id: 'house-robber-ii', name: 'House Robber II', number: 213, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/house-robber-ii/', hasVisualization: false },
  { id: 'longest-palindromic-substring', name: 'Longest Palindromic Substring', number: 5, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/longest-palindromic-substring/', hasVisualization: false },
  { id: 'palindromic-substrings', name: 'Palindromic Substrings', number: 647, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/palindromic-substrings/', hasVisualization: false },
  { id: 'decode-ways', name: 'Decode Ways', number: 91, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/decode-ways/', hasVisualization: false },
  { id: 'coin-change', name: 'Coin Change', number: 322, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/coin-change/', hasVisualization: false },
  { id: 'maximum-product-subarray', name: 'Maximum Product Subarray', number: 152, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/maximum-product-subarray/', hasVisualization: false },
  { id: 'word-break', name: 'Word Break', number: 139, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/word-break/', hasVisualization: false },
  { id: 'longest-increasing-subsequence', name: 'Longest Increasing Subsequence', number: 300, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/longest-increasing-subsequence/', hasVisualization: false },
  { id: 'partition-equal-subset-sum', name: 'Partition Equal Subset Sum', number: 416, difficulty: 'Medium', topicId: '1d-dp', link: 'https://leetcode.com/problems/partition-equal-subset-sum/', hasVisualization: false },
